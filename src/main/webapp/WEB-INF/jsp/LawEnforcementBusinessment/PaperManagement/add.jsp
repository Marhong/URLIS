...
<head>
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/static/js/paper/add.js"></script>
    <style type="text/css">
        body {
            padding-bottom: 40px;
        }
...
<table class="table table-bordered table-hover definewidth m10">
    <tr>
        ...
        <td><input type="text" name="paper_name" id="paper_name"/><input type="hidden" id="paper_id" name="paper_id" /></td>
    </tr>
    <tr>
        <td width="10%" class="tableleft">考卷分数</td>
        <td><input type="text" name="papaer_score" id="paper_score" value="100"  readonly /></td>
    </tr>
    <tr>
        <td width="10%" class="tableleft">考试时长</td>
        <td><input type="text" name="paper_time" id="paper_time"/></td>
    </tr>
    <tr>
        <td width="10%" class="tableleft">考卷备注</td>
        <td><textarea cols="50" rows="3" name="paper_remark"  style="resize:none" id="paper_remark"></textarea></td>
    </tr>
    <tr>
	 <td width="10%" class="tableleft">选题<br/>&nbsp;&nbsp;&nbsp;&nbsp;还须选选择题:<span id="choiceItems">5</span>题<br/>&nbsp;&nbsp;&nbsp;&nbsp;还须选判断题:<span id="judgementItems">5</span>题</td>
	 <td >
       <table class="table table-bordered table-hover definewidth m10" id="table">
			<thead>
			<tr>
				<th width="5%"><select class="form-control" name="type" id="type">
				<option>选择题</option>
				<option>判断题</option>
			</select></th>
				<th>题目编号</th>
